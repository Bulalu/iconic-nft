  ...
  */
  const connectWallet = async () => {
    try {
      ...
      if (!ethereum) {
        alert("Yep it wont work now go Get MetaMask!, giggity");
        return;
      }
  ...
  const askContractToMintNft = async () => {
    ...
    try {
      ...
      if (ethereum) {
        ...
        let nftTxn = await connectedContract.makeAnIconicNFT();
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <p className="header gradient-text">Yo Checkout My NFT Collection</p>
